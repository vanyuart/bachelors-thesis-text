...
%Management of the process is outside the application scope.
%The main aim is to motivate the user, manage plans and results.
...
Steps from above describe the recommended approach to the personal development.
