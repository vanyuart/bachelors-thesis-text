...
\ctusetup{
    ...
    keywords-english = {personal development, competitiveness, Kotlin, Spring, React},
    keywords-czech = {osobní rozvoj, soutěživost, Kotlin, Spring, React},
...
%    Analysis for the new application will be proposed based on the performed research.
    This paper researches the domain of personal development and the possibility of using competitiveness as a motivation for personal development.
...
%    Na základně provedené rešerší bude navržená analýza nové aplikace.
    ...
    Na základě tohoto navrhu byla implementována a otestována první verze aplikace.
\end{abstract-czech}
...
%    Testing
    ...
    \begin{thebibliography}{99}
        ...
        \bibitem{google-market-share} Ryckman, R. M., Thornton, B., and Gold, J. A.
